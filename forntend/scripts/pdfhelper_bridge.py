...
def run_pipeline(
	...
	*,
	...
	if json_path:
		...
		translated_name = translated_json_path.name
		emit_status("rag", "start", collection=translated_name)
		rag_start = time.time()
		rag_result: HelperResult = helper.add_json_to_rag(translated_name)
